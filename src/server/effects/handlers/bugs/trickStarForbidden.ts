...
/**
 * TrickStar-Forbidden bug effect handler.
 * Trigger: (suppression only — handler never called via EffectResolver)
 *
 * Suppresses the TrickStar strategy handler for the affected player.
...
export function trickStarForbidden(_game: Game, _ctx: EffectContext): GamePatch {
  return {};
}
